...
if __name__ == '__main__':
    ...
    parser.add_argument('-h1', '--hidden1', type=int, default=128, help='the hidden_1 is u_hidden_size')
    parser.add_argument('-h2', '--hidden2', type=int, default=64, help='the hidden_2 is i_hidden_size')
